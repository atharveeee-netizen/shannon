    ...
    return (
      <div className="p-6 w-full max-w-none">
        <EmptyState
          ...
          description="Compile a model to generate the zero-malloc C99 header and ready-to-flash firmware starter templates."
          allowCompile={true}
        />
      </div>
    );
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-border pb-5">
        <div className="space-y-1">
          ...
          <p className="text-xs text-text-secondary max-w-4xl">
            Standalone C99 header (<code>shannon_model.h</code>) with verified 0-malloc execution and zero runtime external dependencies.
          </p>
        </div>

        <button
          onClick={downloadHeader}
          className="flex items-center gap-1.5 px-4 py-2 rounded-md bg-primary hover:bg-primary-hover text-white text-xs font-bold shadow-sm self-start transition-all cursor-pointer"
        >
          <Download className="w-4 h-4" />
                  ...
                  <div
                    ...
                    className={`p-3 rounded-lg border text-xs cursor-pointer transition-all space-y-1.5 ${
                      isSelected
                        ...
                        : 'bg-surface border-border hover:bg-surface-raised/60'
                    }`}
                  >
          ...
          <Panel
            ...
            headerRight={
              <button
                ...
                className="flex items-center gap-1 px-2.5 py-1 rounded-md bg-surface-raised border border-border hover:bg-surface-hover text-text-primary text-xs font-mono transition-colors cursor-pointer"
              >
          ...
          >
            <div className="space-y-4 text-xs font-mono">
              <div className="space-y-2 text-text-secondary font-sans">
                ...
                <div className="p-3 rounded-lg bg-surface-raised border border-border font-mono text-xs text-primary font-semibold">
                ...
                <div className="p-3.5 rounded-lg bg-surface-raised border border-border font-mono text-xs text-text-primary overflow-x-auto space-y-1.5 leading-relaxed">
                  ...
                  <div className="text-primary font-bold">shannon_run_inference(sensor_sample, predictions);</div>
                </div>
              </div>
            </div>
          </Panel>
