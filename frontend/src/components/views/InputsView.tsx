    ...
    <div className="p-6 space-y-6 max-w-7xl mx-auto">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-border pb-5">
        ...
        <button
          ...
          className="flex items-center gap-1.5 px-3.5 py-1.5 rounded bg-accent hover:bg-accent-hover text-black text-xs font-semibold self-start"
        >
            ...
            <div className="space-y-4 text-xs font-mono">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="p-4 rounded bg-surface-raised/40 border border-border space-y-1">
                  <div className="flex items-center gap-2 text-text-muted text-[11px]">
                    {isAudio ? <Radio className="w-3.5 h-3.5 text-accent" /> : isVision ? <Camera className="w-3.5 h-3.5 text-accent" /> : <Activity className="w-3.5 h-3.5 text-accent" />}
              ...
              <div className="space-y-2 pt-2 border-t border-border">
                <div className="flex justify-between py-1.5 border-b border-border/50 text-text-secondary">
                  ...
                  <span className="text-accent font-bold">{inputTensor}</span>
                </div>
                <div className="flex justify-between py-1.5 border-b border-border/50 text-text-secondary">
