...
export const Sidebar: React.FC = () => {
  ...
  return (
    <aside
      className={`bg-surface border-r border-border flex flex-col flex-shrink-0 select-none h-screen sticky top-0 transition-all duration-200 ${
        isCollapsed ? 'w-16' : 'w-64'
      }`}
    >
      {/* Brand Header */}
      <div className="h-14 flex items-center justify-between px-3 border-b border-border bg-surface-raised/40">
        <div className="flex items-center gap-2.5 overflow-hidden">
          <div className="w-7 h-7 rounded bg-accent-subtle border border-accent/30 flex items-center justify-center text-accent font-bold text-sm flex-shrink-0">
                  ...
                  {sec.items.map((item) => {
                    ...
                    return (
                      <button
                        ...
                        } py-1.5 rounded text-xs transition-all group ${
                          isActive
      ...
      <div className="p-2.5 border-t border-border bg-surface-raised/20 space-y-2">
        <button
        ...
        >
          <div className="flex items-center gap-2">
            <div className="w-5 h-5 rounded bg-surface-raised border border-border flex items-center justify-center text-accent flex-shrink-0">
          ...
          {!isCollapsed && <Sparkles className="w-3.5 h-3.5 text-accent flex-shrink-0" />}
        </button>
