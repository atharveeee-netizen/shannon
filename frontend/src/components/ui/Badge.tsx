...
export const Badge: React.FC<BadgeProps> = ({
  ...
  return (
    <span
      className={`inline-flex items-center gap-1 px-1.5 py-0.5 rounded-[2px] border text-[10px] font-mono font-medium leading-none select-none ${variantStyles[variant]} ${className}`}
    >
      {children}
    </span>
  );
